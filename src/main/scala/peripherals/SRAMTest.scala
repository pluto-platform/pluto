...
import fpga.DE2_115._
import fpga.Pin
import lib.modules.TriStateDriver
import peripherals.SRAMTest.State
...
object SRAMTestRunner extends App {
  ...
  println(Process("/opt/intel/21.1/quartus/bin/quartus_map peripherals.SRAMTest",new File("quartus")).!)
  println(Process("/opt/intel/21.1/quartus/bin/quartus_fit peripherals.SRAMTest",new File("quartus")).!)
  println(Process("/opt/intel/21.1/quartus/bin/quartus_asm peripherals.SRAMTest",new File("quartus")).!)
  println(Process("/opt/intel/21.1/quartus/bin/quartus_pgm -c USB-Blaster -m jtag -o p;peripherals.SRAMTest.sof",new File("quartus")).!)
