...
object Instructions {
  ...
  def XPERM16            = BitPat("b0010100??????????110?????0110011")
  ...
  def BCOMPRESSW         = BitPat("b0000100??????????110?????0111011")
  def BDECOMPRESSW       = BitPat("b0100100??????????110?????0111011")
  def PACKW              = BitPat("b0000100??????????100?????0111011")
  def PACKUW             = BitPat("b0100100??????????100?????0111011")
  def BFPW               = BitPat("b0100100??????????111?????0111011")
  def XPERM32            = BitPat("b0010100??????????000?????0110011")
  ...
  def PREFETCH_I         = BitPat("b???????00000?????110000000010011")
  def PREFETCH_R         = BitPat("b???????00001?????110000000010011")
  def PREFETCH_W         = BitPat("b???????00011?????110000000010011")
  ...
  def ADD8               = BitPat("b0100100??????????000?????1110111")
  def ADD16              = BitPat("b0100000??????????000?????1110111")
  def ADD64              = BitPat("b1100000??????????001?????1110111")
  def AVE                = BitPat("b1110000??????????000?????1110111")
  def BITREV             = BitPat("b1110011??????????000?????1110111")
  def BITREVI            = BitPat("b111010???????????000?????1110111")
  def BPICK              = BitPat("b?????00??????????011?????1110111")
  def CLRS8              = BitPat("b101011100000?????000?????1110111")
  def CLRS16             = BitPat("b101011101000?????000?????1110111")
  def CLRS32             = BitPat("b101011111000?????000?????1110111")
  def CLO8               = BitPat("b101011100011?????000?????1110111")
  def CLO16              = BitPat("b101011101011?????000?????1110111")
  def CLO32              = BitPat("b101011111011?????000?????1110111")
  def CLZ8               = BitPat("b101011100001?????000?????1110111")
  def CLZ16              = BitPat("b101011101001?????000?????1110111")
  def CLZ32              = BitPat("b101011111001?????000?????1110111")
  def CMPEQ8             = BitPat("b0100111??????????000?????1110111")
  def CMPEQ16            = BitPat("b0100110??????????000?????1110111")
  def CRAS16             = BitPat("b0100010??????????000?????1110111")
  def CRSA16             = BitPat("b0100011??????????000?????1110111")
  def INSB               = BitPat("b101011000????????000?????1110111")
  def KABS8              = BitPat("b101011010000?????000?????1110111")
  def KABS16             = BitPat("b101011010001?????000?????1110111")
  def KABSW              = BitPat("b101011010100?????000?????1110111")
  def KADD8              = BitPat("b0001100??????????000?????1110111")
  def KADD16             = BitPat("b0001000??????????000?????1110111")
  def KADD64             = BitPat("b1001000??????????001?????1110111")
  def KADDH              = BitPat("b0000010??????????001?????1110111")
  def KADDW              = BitPat("b0000000??????????001?????1110111")
  def KCRAS16            = BitPat("b0001010??????????000?????1110111")
  def KCRSA16            = BitPat("b0001011??????????000?????1110111")
  def KDMBB              = BitPat("b0000101??????????001?????1110111")
  def KDMBT              = BitPat("b0001101??????????001?????1110111")
  def KDMTT              = BitPat("b0010101??????????001?????1110111")
  def KDMABB             = BitPat("b1101001??????????001?????1110111")
  def KDMABT             = BitPat("b1110001??????????001?????1110111")
  def KDMATT             = BitPat("b1111001??????????001?????1110111")
  def KHM8               = BitPat("b1000111??????????000?????1110111")
  def KHMX8              = BitPat("b1001111??????????000?????1110111")
  def KHM16              = BitPat("b1000011??????????000?????1110111")
  def KHMX16             = BitPat("b1001011??????????000?????1110111")
  def KHMBB              = BitPat("b0000110??????????001?????1110111")
  def KHMBT              = BitPat("b0001110??????????001?????1110111")
  def KHMTT              = BitPat("b0010110??????????001?????1110111")
  def KMABB              = BitPat("b0101101??????????001?????1110111")
  def KMABT              = BitPat("b0110101??????????001?????1110111")
  def KMATT              = BitPat("b0111101??????????001?????1110111")
  def KMADA              = BitPat("b0100100??????????001?????1110111")
  def KMAXDA             = BitPat("b0100101??????????001?????1110111")
  def KMADS              = BitPat("b0101110??????????001?????1110111")
  def KMADRS             = BitPat("b0110110??????????001?????1110111")
  def KMAXDS             = BitPat("b0111110??????????001?????1110111")
  def KMAR64             = BitPat("b1001010??????????001?????1110111")
  def KMDA               = BitPat("b0011100??????????001?????1110111")
  def KMXDA              = BitPat("b0011101??????????001?????1110111")
  def KMMAC              = BitPat("b0110000??????????001?????1110111")
  def KMMAC_U            = BitPat("b0111000??????????001?????1110111")
  def KMMAWB             = BitPat("b0100011??????????001?????1110111")
  def KMMAWB_U           = BitPat("b0101011??????????001?????1110111")
  def KMMAWB2            = BitPat("b1100111??????????001?????1110111")
  def KMMAWB2_U          = BitPat("b1101111??????????001?????1110111")
  def KMMAWT             = BitPat("b0110011??????????001?????1110111")
  def KMMAWT_U           = BitPat("b0111011??????????001?????1110111")
  def KMMAWT2            = BitPat("b1110111??????????001?????1110111")
  def KMMAWT2_U          = BitPat("b1111111??????????001?????1110111")
  def KMMSB              = BitPat("b0100001??????????001?????1110111")
  def KMMSB_U            = BitPat("b0101001??????????001?????1110111")
  def KMMWB2             = BitPat("b1000111??????????001?????1110111")
  def KMMWB2_U           = BitPat("b1001111??????????001?????1110111")
  def KMMWT2             = BitPat("b1010111??????????001?????1110111")
  def KMMWT2_U           = BitPat("b1011111??????????001?????1110111")
  def KMSDA              = BitPat("b0100110??????????001?????1110111")
  def KMSXDA             = BitPat("b0100111??????????001?????1110111")
  def KMSR64             = BitPat("b1001011??????????001?????1110111")
  def KSLLW              = BitPat("b0010011??????????001?????1110111")
  def KSLLIW             = BitPat("b0011011??????????001?????1110111")
  def KSLL8              = BitPat("b0110110??????????000?????1110111")
  def KSLLI8             = BitPat("b011111001????????000?????1110111")
  def KSLL16             = BitPat("b0110010??????????000?????1110111")
  def KSLLI16            = BitPat("b01110101?????????000?????1110111")
  def KSLRA8             = BitPat("b0101111??????????000?????1110111")
  def KSLRA8_U           = BitPat("b0110111??????????000?????1110111")
  def KSLRA16            = BitPat("b0101011??????????000?????1110111")
  def KSLRA16_U          = BitPat("b0110011??????????000?????1110111")
  def KSLRAW             = BitPat("b0110111??????????001?????1110111")
  def KSLRAW_U           = BitPat("b0111111??????????001?????1110111")
  def KSTAS16            = BitPat("b1100010??????????010?????1110111")
  def KSTSA16            = BitPat("b1100011??????????010?????1110111")
  def KSUB8              = BitPat("b0001101??????????000?????1110111")
  def KSUB16             = BitPat("b0001001??????????000?????1110111")
  def KSUB64             = BitPat("b1001001??????????001?????1110111")
  def KSUBH              = BitPat("b0000011??????????001?????1110111")
  def KSUBW              = BitPat("b0000001??????????001?????1110111")
  def KWMMUL             = BitPat("b0110001??????????001?????1110111")
  def KWMMUL_U           = BitPat("b0111001??????????001?????1110111")
  def MADDR32            = BitPat("b1100010??????????001?????1110111")
  def MAXW               = BitPat("b1111001??????????000?????1110111")
  def MINW               = BitPat("b1111000??????????000?????1110111")
  def MSUBR32            = BitPat("b1100011??????????001?????1110111")
  def MULR64             = BitPat("b1111000??????????001?????1110111")
  def MULSR64            = BitPat("b1110000??????????001?????1110111")
  def PBSAD              = BitPat("b1111110??????????000?????1110111")
  def PBSADA             = BitPat("b1111111??????????000?????1110111")
  def PKBB16             = BitPat("b0000111??????????001?????1110111")
  def PKBT16             = BitPat("b0001111??????????001?????1110111")
  def PKTT16             = BitPat("b0010111??????????001?????1110111")
  def PKTB16             = BitPat("b0011111??????????001?????1110111")
  def RADD8              = BitPat("b0000100??????????000?????1110111")
  def RADD16             = BitPat("b0000000??????????000?????1110111")
  def RADD64             = BitPat("b1000000??????????001?????1110111")
  def RADDW              = BitPat("b0010000??????????001?????1110111")
  def RCRAS16            = BitPat("b0000010??????????000?????1110111")
  def RCRSA16            = BitPat("b0000011??????????000?????1110111")
  def RSTAS16            = BitPat("b1011010??????????010?????1110111")
  def RSTSA16            = BitPat("b1011011??????????010?????1110111")
  def RSUB8              = BitPat("b0000101??????????000?????1110111")
  def RSUB16             = BitPat("b0000001??????????000?????1110111")
  def RSUB64             = BitPat("b1000001??????????001?????1110111")
  def RSUBW              = BitPat("b0010001??????????001?????1110111")
  def SCLIP8             = BitPat("b100011000????????000?????1110111")
  def SCLIP16            = BitPat("b10000100?????????000?????1110111")
  def SCLIP32            = BitPat("b1110010??????????000?????1110111")
  def SCMPLE8            = BitPat("b0001111??????????000?????1110111")
  def SCMPLE16           = BitPat("b0001110??????????000?????1110111")
  def SCMPLT8            = BitPat("b0000111??????????000?????1110111")
  def SCMPLT16           = BitPat("b0000110??????????000?????1110111")
  def SLL8               = BitPat("b0101110??????????000?????1110111")
  def SLLI8              = BitPat("b011111000????????000?????1110111")
  def SLL16              = BitPat("b0101010??????????000?????1110111")
  def SLLI16             = BitPat("b01110100?????????000?????1110111")
  def SMAL               = BitPat("b0101111??????????001?????1110111")
  def SMALBB             = BitPat("b1000100??????????001?????1110111")
  def SMALBT             = BitPat("b1001100??????????001?????1110111")
  def SMALTT             = BitPat("b1010100??????????001?????1110111")
  def SMALDA             = BitPat("b1000110??????????001?????1110111")
  def SMALXDA            = BitPat("b1001110??????????001?????1110111")
  def SMALDS             = BitPat("b1000101??????????001?????1110111")
  def SMALDRS            = BitPat("b1001101??????????001?????1110111")
  def SMALXDS            = BitPat("b1010101??????????001?????1110111")
  def SMAR64             = BitPat("b1000010??????????001?????1110111")
  def SMAQA              = BitPat("b1100100??????????000?????1110111")
  def SMAQA_SU           = BitPat("b1100101??????????000?????1110111")
  def SMAX8              = BitPat("b1000101??????????000?????1110111")
  def SMAX16             = BitPat("b1000001??????????000?????1110111")
  def SMBB16             = BitPat("b0000100??????????001?????1110111")
  def SMBT16             = BitPat("b0001100??????????001?????1110111")
  def SMTT16             = BitPat("b0010100??????????001?????1110111")
  def SMDS               = BitPat("b0101100??????????001?????1110111")
  def SMDRS              = BitPat("b0110100??????????001?????1110111")
  def SMXDS              = BitPat("b0111100??????????001?????1110111")
  def SMIN8              = BitPat("b1000100??????????000?????1110111")
  def SMIN16             = BitPat("b1000000??????????000?????1110111")
  def SMMUL              = BitPat("b0100000??????????001?????1110111")
  def SMMUL_U            = BitPat("b0101000??????????001?????1110111")
  def SMMWB              = BitPat("b0100010??????????001?????1110111")
  def SMMWB_U            = BitPat("b0101010??????????001?????1110111")
  def SMMWT              = BitPat("b0110010??????????001?????1110111")
  def SMMWT_U            = BitPat("b0111010??????????001?????1110111")
  def SMSLDA             = BitPat("b1010110??????????001?????1110111")
  def SMSLXDA            = BitPat("b1011110??????????001?????1110111")
  def SMSR64             = BitPat("b1000011??????????001?????1110111")
  def SMUL8              = BitPat("b1010100??????????000?????1110111")
  def SMULX8             = BitPat("b1010101??????????000?????1110111")
  def SMUL16             = BitPat("b1010000??????????000?????1110111")
  def SMULX16            = BitPat("b1010001??????????000?????1110111")
  def SRA_U              = BitPat("b0010010??????????001?????1110111")
  def SRAI_U             = BitPat("b110101???????????001?????1110111")
  def SRA8               = BitPat("b0101100??????????000?????1110111")
  def SRA8_U             = BitPat("b0110100??????????000?????1110111")
  def SRAI8              = BitPat("b011110000????????000?????1110111")
  def SRAI8_U            = BitPat("b011110001????????000?????1110111")
  def SRA16              = BitPat("b0101000??????????000?????1110111")
  def SRA16_U            = BitPat("b0110000??????????000?????1110111")
  def SRAI16             = BitPat("b01110000?????????000?????1110111")
  def SRAI16_U           = BitPat("b01110001?????????000?????1110111")
  def SRL8               = BitPat("b0101101??????????000?????1110111")
  def SRL8_U             = BitPat("b0110101??????????000?????1110111")
  def SRLI8              = BitPat("b011110100????????000?????1110111")
  def SRLI8_U            = BitPat("b011110101????????000?????1110111")
  def SRL16              = BitPat("b0101001??????????000?????1110111")
  def SRL16_U            = BitPat("b0110001??????????000?????1110111")
  def SRLI16             = BitPat("b01110010?????????000?????1110111")
  def SRLI16_U           = BitPat("b01110011?????????000?????1110111")
  def STAS16             = BitPat("b1111010??????????010?????1110111")
  def STSA16             = BitPat("b1111011??????????010?????1110111")
  def SUB8               = BitPat("b0100101??????????000?????1110111")
  def SUB16              = BitPat("b0100001??????????000?????1110111")
  def SUB64              = BitPat("b1100001??????????001?????1110111")
  def SUNPKD810          = BitPat("b101011001000?????000?????1110111")
  def SUNPKD820          = BitPat("b101011001001?????000?????1110111")
  def SUNPKD830          = BitPat("b101011001010?????000?????1110111")
  def SUNPKD831          = BitPat("b101011001011?????000?????1110111")
  def SUNPKD832          = BitPat("b101011010011?????000?????1110111")
  def SWAP8              = BitPat("b101011011000?????000?????1110111")
  def UCLIP8             = BitPat("b100011010????????000?????1110111")
  def UCLIP16            = BitPat("b10000101?????????000?????1110111")
  def UCLIP32            = BitPat("b1111010??????????000?????1110111")
  def UCMPLE8            = BitPat("b0011111??????????000?????1110111")
  def UCMPLE16           = BitPat("b0011110??????????000?????1110111")
  def UCMPLT8            = BitPat("b0010111??????????000?????1110111")
  def UCMPLT16           = BitPat("b0010110??????????000?????1110111")
  def UKADD8             = BitPat("b0011100??????????000?????1110111")
  def UKADD16            = BitPat("b0011000??????????000?????1110111")
  def UKADD64            = BitPat("b1011000??????????001?????1110111")
  def UKADDH             = BitPat("b0001010??????????001?????1110111")
  def UKADDW             = BitPat("b0001000??????????001?????1110111")
  def UKCRAS16           = BitPat("b0011010??????????000?????1110111")
  def UKCRSA16           = BitPat("b0011011??????????000?????1110111")
  def UKMAR64            = BitPat("b1011010??????????001?????1110111")
  def UKMSR64            = BitPat("b1011011??????????001?????1110111")
  def UKSTAS16           = BitPat("b1110010??????????010?????1110111")
  def UKSTSA16           = BitPat("b1110011??????????010?????1110111")
  def UKSUB8             = BitPat("b0011101??????????000?????1110111")
  def UKSUB16            = BitPat("b0011001??????????000?????1110111")
  def UKSUB64            = BitPat("b1011001??????????001?????1110111")
  def UKSUBH             = BitPat("b0001011??????????001?????1110111")
  def UKSUBW             = BitPat("b0001001??????????001?????1110111")
  def UMAR64             = BitPat("b1010010??????????001?????1110111")
  def UMAQA              = BitPat("b1100110??????????000?????1110111")
  def UMAX8              = BitPat("b1001101??????????000?????1110111")
  def UMAX16             = BitPat("b1001001??????????000?????1110111")
  def UMIN8              = BitPat("b1001100??????????000?????1110111")
  def UMIN16             = BitPat("b1001000??????????000?????1110111")
  def UMSR64             = BitPat("b1010011??????????001?????1110111")
  def UMUL8              = BitPat("b1011100??????????000?????1110111")
  def UMULX8             = BitPat("b1011101??????????000?????1110111")
  def UMUL16             = BitPat("b1011000??????????000?????1110111")
  def UMULX16            = BitPat("b1011001??????????000?????1110111")
  def URADD8             = BitPat("b0010100??????????000?????1110111")
  def URADD16            = BitPat("b0010000??????????000?????1110111")
  def URADD64            = BitPat("b1010000??????????001?????1110111")
  def URADDW             = BitPat("b0011000??????????001?????1110111")
  def URCRAS16           = BitPat("b0010010??????????000?????1110111")
  def URCRSA16           = BitPat("b0010011??????????000?????1110111")
  def URSTAS16           = BitPat("b1101010??????????010?????1110111")
  def URSTSA16           = BitPat("b1101011??????????010?????1110111")
  def URSUB8             = BitPat("b0010101??????????000?????1110111")
  def URSUB16            = BitPat("b0010001??????????000?????1110111")
  def URSUB64            = BitPat("b1010001??????????001?????1110111")
  def URSUBW             = BitPat("b0011001??????????001?????1110111")
  def WEXTI              = BitPat("b1101111??????????000?????1110111")
  def WEXT               = BitPat("b1100111??????????000?????1110111")
  def ZUNPKD810          = BitPat("b101011001100?????000?????1110111")
  def ZUNPKD820          = BitPat("b101011001101?????000?????1110111")
  def ZUNPKD830          = BitPat("b101011001110?????000?????1110111")
  def ZUNPKD831          = BitPat("b101011001111?????000?????1110111")
  def ZUNPKD832          = BitPat("b101011010111?????000?????1110111")
  def ADD32              = BitPat("b0100000??????????010?????1110111")
  def CRAS32             = BitPat("b0100010??????????010?????1110111")
  def CRSA32             = BitPat("b0100011??????????010?????1110111")
  def KABS32             = BitPat("b101011010010?????000?????1110111")
  def KADD32             = BitPat("b0001000??????????010?????1110111")
  def KCRAS32            = BitPat("b0001010??????????010?????1110111")
  def KCRSA32            = BitPat("b0001011??????????010?????1110111")
  def KDMBB16            = BitPat("b1101101??????????001?????1110111")
  def KDMBT16            = BitPat("b1110101??????????001?????1110111")
  def KDMTT16            = BitPat("b1111101??????????001?????1110111")
  def KDMABB16           = BitPat("b1101100??????????001?????1110111")
  def KDMABT16           = BitPat("b1110100??????????001?????1110111")
  def KDMATT16           = BitPat("b1111100??????????001?????1110111")
  def KHMBB16            = BitPat("b1101110??????????001?????1110111")
  def KHMBT16            = BitPat("b1110110??????????001?????1110111")
  def KHMTT16            = BitPat("b1111110??????????001?????1110111")
  def KMABB32            = BitPat("b0101101??????????010?????1110111")
  def KMABT32            = BitPat("b0110101??????????010?????1110111")
  def KMATT32            = BitPat("b0111101??????????010?????1110111")
  def KMAXDA32           = BitPat("b0100101??????????010?????1110111")
  def KMDA32             = BitPat("b0011100??????????010?????1110111")
  def KMXDA32            = BitPat("b0011101??????????010?????1110111")
  def KMADS32            = BitPat("b0101110??????????010?????1110111")
  def KMADRS32           = BitPat("b0110110??????????010?????1110111")
  def KMAXDS32           = BitPat("b0111110??????????010?????1110111")
  def KMSDA32            = BitPat("b0100110??????????010?????1110111")
  def KMSXDA32           = BitPat("b0100111??????????010?????1110111")
  def KSLL32             = BitPat("b0110010??????????010?????1110111")
  def KSLLI32            = BitPat("b1000010??????????010?????1110111")
  def KSLRA32            = BitPat("b0101011??????????010?????1110111")
  def KSLRA32_U          = BitPat("b0110011??????????010?????1110111")
  def KSTAS32            = BitPat("b1100000??????????010?????1110111")
  def KSTSA32            = BitPat("b1100001??????????010?????1110111")
  def KSUB32             = BitPat("b0001001??????????010?????1110111")
  def PKBB32             = BitPat("b0000111??????????010?????1110111")
  def PKBT32             = BitPat("b0001111??????????010?????1110111")
  def PKTT32             = BitPat("b0010111??????????010?????1110111")
  def PKTB32             = BitPat("b0011111??????????010?????1110111")
  def RADD32             = BitPat("b0000000??????????010?????1110111")
  def RCRAS32            = BitPat("b0000010??????????010?????1110111")
  def RCRSA32            = BitPat("b0000011??????????010?????1110111")
  def RSTAS32            = BitPat("b1011000??????????010?????1110111")
  def RSTSA32            = BitPat("b1011001??????????010?????1110111")
  def RSUB32             = BitPat("b0000001??????????010?????1110111")
  def SLL32              = BitPat("b0101010??????????010?????1110111")
  def SLLI32             = BitPat("b0111010??????????010?????1110111")
  def SMAX32             = BitPat("b1001001??????????010?????1110111")
  def SMBT32             = BitPat("b0001100??????????010?????1110111")
  def SMTT32             = BitPat("b0010100??????????010?????1110111")
  def SMDS32             = BitPat("b0101100??????????010?????1110111")
  def SMDRS32            = BitPat("b0110100??????????010?????1110111")
  def SMXDS32            = BitPat("b0111100??????????010?????1110111")
  def SMIN32             = BitPat("b1001000??????????010?????1110111")
  def SRA32              = BitPat("b0101000??????????010?????1110111")
  def SRA32_U            = BitPat("b0110000??????????010?????1110111")
  def SRAI32             = BitPat("b0111000??????????010?????1110111")
  def SRAI32_U           = BitPat("b1000000??????????010?????1110111")
  def SRAIW_U            = BitPat("b0011010??????????001?????1110111")
  def SRL32              = BitPat("b0101001??????????010?????1110111")
  def SRL32_U            = BitPat("b0110001??????????010?????1110111")
  def SRLI32             = BitPat("b0111001??????????010?????1110111")
  def SRLI32_U           = BitPat("b1000001??????????010?????1110111")
  def STAS32             = BitPat("b1111000??????????010?????1110111")
  def STSA32             = BitPat("b1111001??????????010?????1110111")
  def SUB32              = BitPat("b0100001??????????010?????1110111")
  def UKADD32            = BitPat("b0011000??????????010?????1110111")
  def UKCRAS32           = BitPat("b0011010??????????010?????1110111")
  def UKCRSA32           = BitPat("b0011011??????????010?????1110111")
  def UKSTAS32           = BitPat("b1110000??????????010?????1110111")
  def UKSTSA32           = BitPat("b1110001??????????010?????1110111")
  def UKSUB32            = BitPat("b0011001??????????010?????1110111")
  def UMAX32             = BitPat("b1010001??????????010?????1110111")
  def UMIN32             = BitPat("b1010000??????????010?????1110111")
  def URADD32            = BitPat("b0010000??????????010?????1110111")
  def URCRAS32           = BitPat("b0010010??????????010?????1110111")
  def URCRSA32           = BitPat("b0010011??????????010?????1110111")
  def URSTAS32           = BitPat("b1101000??????????010?????1110111")
  def URSTSA32           = BitPat("b1101001??????????010?????1110111")
  def URSUB32            = BitPat("b0010001??????????010?????1110111")
  def VMVNFR_V           = BitPat("b1001111??????????011?????1010111")
  def VL1R_V             = BitPat("b000000101000?????000?????0000111")
  def VL2R_V             = BitPat("b000001101000?????101?????0000111")
  def VL4R_V             = BitPat("b000011101000?????110?????0000111")
  def VL8R_V             = BitPat("b000111101000?????111?????0000111")
  def VLE1_V             = BitPat("b000000101011?????000?????0000111")
  def VSE1_V             = BitPat("b000000101011?????000?????0100111")
